...
pub extern fn ___tracy_set_thread_name(name: [*c]const u8) void;
pub const struct____tracy_source_location_data = extern struct {
    name: [*c]const u8,
    function: [*c]const u8,
    file: [*c]const u8,
    line: u32,
...
pub const struct____tracy_gpu_time_data = extern struct {
    gpuTime: i64,
    queryId: u16,
    context: u8,
};
pub const struct____tracy_gpu_zone_begin_data = extern struct {
    srcloc: u64,
    queryId: u16,
    context: u8,
};
pub const struct____tracy_gpu_zone_begin_callstack_data = extern struct {
    srcloc: u64,
    depth: c_int,
    queryId: u16,
    context: u8,
};
pub const struct____tracy_gpu_zone_end_data = extern struct {
    queryId: u16,
    context: u8,
};
pub const struct____tracy_gpu_new_context_data = extern struct {
    gpuTime: i64,
    period: f32,
    context: u8,
    flags: u8,
...
pub const struct____tracy_gpu_context_name_data = extern struct {
    context: u8,
    name: [*c]const u8,
    len: u16,
};
pub const struct____tracy_gpu_calibration_data = extern struct {
    gpuTime: i64,
    cpuDelta: i64,
    context: u8,
};
pub const TracyCZoneCtx = struct____tracy_c_zone_context;
pub extern fn ___tracy_alloc_srcloc(line: u32, source: [*c]const u8, sourceSz: usize, function: [*c]const u8, functionSz: usize) u64;
pub extern fn ___tracy_alloc_srcloc_name(line: u32, source: [*c]const u8, sourceSz: usize, function: [*c]const u8, functionSz: usize, name: [*c]const u8, nameSz: usize) u64;
pub extern fn ___tracy_emit_zone_begin(srcloc: [*c]const struct____tracy_source_location_data, active: c_int) TracyCZoneCtx;
pub extern fn ___tracy_emit_zone_begin_callstack(srcloc: [*c]const struct____tracy_source_location_data, depth: c_int, active: c_int) TracyCZoneCtx;
pub extern fn ___tracy_emit_zone_begin_alloc(srcloc: u64, active: c_int) TracyCZoneCtx;
pub extern fn ___tracy_emit_zone_begin_alloc_callstack(srcloc: u64, depth: c_int, active: c_int) TracyCZoneCtx;
pub extern fn ___tracy_emit_zone_end(ctx: TracyCZoneCtx) void;
pub extern fn ___tracy_emit_zone_text(ctx: TracyCZoneCtx, txt: [*c]const u8, size: usize) void;
pub extern fn ___tracy_emit_zone_name(ctx: TracyCZoneCtx, txt: [*c]const u8, size: usize) void;
pub extern fn ___tracy_emit_zone_color(ctx: TracyCZoneCtx, color: u32) void;
pub extern fn ___tracy_emit_zone_value(ctx: TracyCZoneCtx, value: u64) void;
pub extern fn ___tracy_emit_gpu_zone_begin(struct____tracy_gpu_zone_begin_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_callstack(struct____tracy_gpu_zone_begin_callstack_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_alloc(struct____tracy_gpu_zone_begin_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_alloc_callstack(struct____tracy_gpu_zone_begin_callstack_data) void;
pub extern fn ___tracy_emit_gpu_zone_end(data: struct____tracy_gpu_zone_end_data) void;
pub extern fn ___tracy_emit_gpu_time(struct____tracy_gpu_time_data) void;
pub extern fn ___tracy_emit_gpu_new_context(struct____tracy_gpu_new_context_data) void;
pub extern fn ___tracy_emit_gpu_context_name(struct____tracy_gpu_context_name_data) void;
pub extern fn ___tracy_emit_gpu_calibration(struct____tracy_gpu_calibration_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_serial(struct____tracy_gpu_zone_begin_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_callstack_serial(struct____tracy_gpu_zone_begin_callstack_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_alloc_serial(struct____tracy_gpu_zone_begin_data) void;
pub extern fn ___tracy_emit_gpu_zone_begin_alloc_callstack_serial(struct____tracy_gpu_zone_begin_callstack_data) void;
pub extern fn ___tracy_emit_gpu_zone_end_serial(data: struct____tracy_gpu_zone_end_data) void;
pub extern fn ___tracy_emit_gpu_time_serial(struct____tracy_gpu_time_data) void;
pub extern fn ___tracy_emit_gpu_new_context_serial(struct____tracy_gpu_new_context_data) void;
pub extern fn ___tracy_emit_gpu_context_name_serial(struct____tracy_gpu_context_name_data) void;
pub extern fn ___tracy_emit_gpu_calibration_serial(struct____tracy_gpu_calibration_data) void;
pub extern fn ___tracy_connected() c_int;
...
pub extern fn ___tracy_emit_memory_alloc_named(ptr: ?*const anyopaque, size: usize, secure: c_int, name: [*c]const u8) void;
pub extern fn ___tracy_emit_memory_alloc_callstack_named(ptr: ?*const anyopaque, size: usize, depth: c_int, secure: c_int, name: [*c]const u8) void;
pub extern fn ___tracy_emit_memory_free_named(ptr: ?*const anyopaque, secure: c_int, name: [*c]const u8) void;
pub extern fn ___tracy_emit_memory_free_callstack_named(ptr: ?*const anyopaque, depth: c_int, secure: c_int, name: [*c]const u8) void;
pub extern fn ___tracy_emit_message(txt: [*c]const u8, size: usize, callstack: c_int) void;
pub extern fn ___tracy_emit_messageL(txt: [*c]const u8, callstack: c_int) void;
pub extern fn ___tracy_emit_messageC(txt: [*c]const u8, size: usize, color: u32, callstack: c_int) void;
pub extern fn ___tracy_emit_messageLC(txt: [*c]const u8, color: u32, callstack: c_int) void;
pub extern fn ___tracy_emit_frame_mark(name: [*c]const u8) void;
pub extern fn ___tracy_emit_frame_mark_start(name: [*c]const u8) void;
pub extern fn ___tracy_emit_frame_mark_end(name: [*c]const u8) void;
pub extern fn ___tracy_emit_frame_image(image: ?*const anyopaque, w: u16, h: u16, offset: u8, flip: c_int) void;
pub extern fn ___tracy_emit_plot(name: [*c]const u8, val: f64) void;
pub extern fn ___tracy_emit_plot_float(name: [*c]const u8, val: f32) void;
pub extern fn ___tracy_emit_plot_int(name: [*c]const u8, val: i64) void;
pub extern fn ___tracy_emit_message_appinfo(txt: [*c]const u8, size: usize) void;
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/silver/.opt/zig/lib/include/stddef.h:111:9
...
pub const TRACY_API = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // tracy/tracy/../common/TracyApi.h:13:11
pub const TracyCSetThreadName = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:16:9
pub const TracyFunction = @compileError("unable to translate macro: undefined identifier `__FUNCTION__`"); // tracy/tracy/TracyC.h:19:11
pub const TracyFile = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // tracy/tracy/TracyC.h:23:11
pub const TracyLine = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // tracy/tracy/TracyC.h:27:11
pub const TracyConcatIndirect = @compileError("unable to translate C expr: unexpected token '##'"); // tracy/tracy/TracyC.h:102:11
pub const TracyCZone = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:216:11
pub const TracyCZoneN = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:217:11
pub const TracyCZoneC = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:218:11
pub const TracyCZoneNC = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:219:11
pub const TracyCZoneEnd = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:222:9
pub const TracyCZoneText = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:224:9
pub const TracyCZoneName = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:225:9
pub const TracyCZoneColor = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:226:9
pub const TracyCZoneValue = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:227:9
pub const TracyCAlloc = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:260:11
pub const TracyCFree = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:261:11
pub const TracyCSecureAlloc = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:262:11
pub const TracyCSecureFree = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:263:11
pub const TracyCAllocN = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:265:11
pub const TracyCFreeN = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:266:11
pub const TracyCSecureAllocN = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:267:11
pub const TracyCSecureFreeN = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:268:11
pub const TracyCMessage = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:270:11
pub const TracyCMessageL = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:271:11
pub const TracyCMessageC = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:272:11
pub const TracyCMessageLC = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:273:11
pub const TracyCFrameMark = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:282:9
pub const TracyCFrameMarkNamed = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:283:9
pub const TracyCFrameMarkStart = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:284:9
pub const TracyCFrameMarkEnd = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:285:9
pub const TracyCFrameImage = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:286:9
pub const TracyCPlot = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:294:9
pub const TracyCPlotF = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:295:9
pub const TracyCPlotI = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:296:9
pub const TracyCAppInfo = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:297:9
pub const TracyCZoneS = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:301:11
pub const TracyCZoneNS = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:302:11
pub const TracyCZoneCS = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:303:11
pub const TracyCZoneNCS = @compileError("unable to translate macro: undefined identifier `__tracy_source_location`"); // tracy/tracy/TracyC.h:304:11
pub const TracyCMessageS = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:316:11
pub const TracyCMessageLS = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:317:11
pub const TracyCMessageCS = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:318:11
pub const TracyCMessageLCS = @compileError("unable to translate C expr: unexpected token ';'"); // tracy/tracy/TracyC.h:319:11
...
pub const TRACY_ENABLE = @as(c_int, 1);
pub const __GCC_HAVE_DWARF2_CFI_ASM = @as(c_int, 1);
pub const __TRACYC_HPP__ = "";
...
pub const __TRACYCALLSTACK_H__ = "";
...
pub const TRACY_HAS_CALLSTACK = @as(c_int, 2);
pub const __TRACYAPI_H__ = "";
pub inline fn TracyConcat(x: anytype, y: anytype) @TypeOf(TracyConcatIndirect(x, y)) {
    return TracyConcatIndirect(x, y);
}
pub inline fn TracyCAllocS(ptr: anytype, size: anytype, depth: anytype) @TypeOf(___tracy_emit_memory_alloc_callstack(ptr, size, depth, @as(c_int, 0))) {
    return ___tracy_emit_memory_alloc_callstack(ptr, size, depth, @as(c_int, 0));
}
pub inline fn TracyCFreeS(ptr: anytype, depth: anytype) @TypeOf(___tracy_emit_memory_free_callstack(ptr, depth, @as(c_int, 0))) {
    return ___tracy_emit_memory_free_callstack(ptr, depth, @as(c_int, 0));
}
pub inline fn TracyCSecureAllocS(ptr: anytype, size: anytype, depth: anytype) @TypeOf(___tracy_emit_memory_alloc_callstack(ptr, size, depth, @as(c_int, 1))) {
    return ___tracy_emit_memory_alloc_callstack(ptr, size, depth, @as(c_int, 1));
}
pub inline fn TracyCSecureFreeS(ptr: anytype, depth: anytype) @TypeOf(___tracy_emit_memory_free_callstack(ptr, depth, @as(c_int, 1))) {
    return ___tracy_emit_memory_free_callstack(ptr, depth, @as(c_int, 1));
}
pub inline fn TracyCAllocNS(ptr: anytype, size: anytype, depth: anytype, name: anytype) @TypeOf(___tracy_emit_memory_alloc_callstack_named(ptr, size, depth, @as(c_int, 0), name)) {
    return ___tracy_emit_memory_alloc_callstack_named(ptr, size, depth, @as(c_int, 0), name);
}
pub inline fn TracyCFreeNS(ptr: anytype, depth: anytype, name: anytype) @TypeOf(___tracy_emit_memory_free_callstack_named(ptr, depth, @as(c_int, 0), name)) {
    return ___tracy_emit_memory_free_callstack_named(ptr, depth, @as(c_int, 0), name);
}
pub inline fn TracyCSecureAllocNS(ptr: anytype, size: anytype, depth: anytype, name: anytype) @TypeOf(___tracy_emit_memory_alloc_callstack_named(ptr, size, depth, @as(c_int, 1), name)) {
    return ___tracy_emit_memory_alloc_callstack_named(ptr, size, depth, @as(c_int, 1), name);
}
pub inline fn TracyCSecureFreeNS(ptr: anytype, depth: anytype, name: anytype) @TypeOf(___tracy_emit_memory_free_callstack_named(ptr, depth, @as(c_int, 1), name)) {
    return ___tracy_emit_memory_free_callstack_named(ptr, depth, @as(c_int, 1), name);
}
pub const TracyCIsConnected = ___tracy_connected();
...
pub const ___tracy_source_location_data = struct____tracy_source_location_data;
pub const ___tracy_c_zone_context = struct____tracy_c_zone_context;
pub const ___tracy_gpu_time_data = struct____tracy_gpu_time_data;
pub const ___tracy_gpu_zone_begin_data = struct____tracy_gpu_zone_begin_data;
pub const ___tracy_gpu_zone_begin_callstack_data = struct____tracy_gpu_zone_begin_callstack_data;
pub const ___tracy_gpu_zone_end_data = struct____tracy_gpu_zone_end_data;
pub const ___tracy_gpu_new_context_data = struct____tracy_gpu_new_context_data;
pub const ___tracy_gpu_context_name_data = struct____tracy_gpu_context_name_data;
pub const ___tracy_gpu_calibration_data = struct____tracy_gpu_calibration_data;
